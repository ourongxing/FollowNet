      ...
      {users.length > 0 && (
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-white/20 bg-gray-50/50 dark:bg-white/5">
          <div className="text-sm text-gray-600 dark:text-blue-200">
            共 <span className="font-semibold text-gray-800 dark:text-white">{users.length}</span> 个用户
          </div>
          <Button
            onClick={onExportCSV}
        ...
        <Table className="min-w-[800px]">
          <TableHeader>
            <TableRow className="border-gray-200 dark:border-white/20 hover:bg-gray-50 dark:hover:bg-white/5">
              <TableHead className="text-gray-700 dark:text-blue-200 font-medium">头像</TableHead>
              <SortableTableHead field="username" className="text-gray-700 dark:text-blue-200 font-medium">
                用户信息
              </SortableTableHead>
              <TableHead className="text-gray-700 dark:text-blue-200 font-medium">简介</TableHead>
              <SortableTableHead field="follower_count" className="text-gray-700 dark:text-blue-200 font-medium text-right">
                关注者
              </SortableTableHead>
              <SortableTableHead field="following_count" className="text-gray-700 dark:text-blue-200 font-medium text-right">
                关注中
              </SortableTableHead>
              <SortableTableHead field="public_repos" className="text-gray-700 dark:text-blue-200 font-medium text-right">
                仓库
              </SortableTableHead>
              <TableHead className="text-gray-700 dark:text-blue-200 font-medium">位置/公司</TableHead>
              <TableHead className="text-gray-700 dark:text-blue-200 font-medium">操作</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
              ...
              >
                ...
                <TableCell>
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-gray-800 dark:text-white truncate max-w-[150px]">
